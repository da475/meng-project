...
%%  Concensus Based PSO 
function [Global_best_cost, Global_best_position, Total] = Traditional_PSO(Population,number_of_variables,Iterations)
    ...
    Global_best_cost = inf; % The initial best cost
    Global_best_position = inf; % Initial best position
    ...
    for i = 1:Population
        ...
        % global cost
        if Particle(i).best_cost < Global_best_cost
            Global_best_cost = Particle(i).best_cost;
            Global_best_position = Particle(i).best_position;
        end
    ...
    while (count < Iterations)
        for i = 1:Population
            ...
            Particle(i).velocity = w*Particle(i).velocity...
             ...
             +c2*r2*(Global_best_position-Particle(i).position);
        ...
        Total(count+1) = Global_best_cost;
